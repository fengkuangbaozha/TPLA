...
$tophat/tophat -p 32 -G $gff -o $arg_working_dir/${arg_input_name}_top $genome $arg_working_dir/$arg_input_name/Len_sort_step_4/${arg_input_name}_1.fastq.fq.trimmed.paired1.cut.paired1 $arg_working_dir/$arg_input_name/Len_sort_step_4/${arg_input_name}_1.fastq.fq.trimmed.paired1.cut.paired2  #$file/SRR331227_1.fastq.fq.trimmed.single.cut.single1 
