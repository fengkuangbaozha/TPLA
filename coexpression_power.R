...
gene.high <- read.delim(file="~/sunyd/identify/tomato_rnaseq/SRRall/heatmap/normlnc_expression_gene.high.txt",header=T,stringsAsFactors = FALSE)
lnc.high <- read.delim(file="~/sunyd/identify/tomato_rnaseq/SRRall/heatmap/normlnc_expression_lnc.txt",header=T,stringsAsFactors = FALSE)
lnc.high.del <- read.delim(file="~/sunyd/identify/tomato_rnaseq/SRRall/heatmap/normlnc_expression_lnc.high.del.txt",header=T,stringsAsFactors = FALSE)
genename <- read.delim(file="~/sunyd/identify/tomato_rnaseq/SRRall/cuff228.combined.gtf-correspond-genename-GO",header=F,stringsAsFactors = FALSE)
kmean.floral <- read.delim(file="~/sunyd/identify/tomato_rnaseq/SRRall/heatmap/normlnckcluster.floral",header=F,stringsAsFactors = FALSE)
filename <- "~/sunyd/identify/tomato_rnaseq/SRRall/coexpression/floral."
