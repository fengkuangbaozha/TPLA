...
cat $dir/split_cuff/cuff_ml*/*.rfmodel > $dir/split_cuff/cuff.rfmodel
cut -f 1 $dir/split_cuff/cuff.rfmodel |sort -u > $dir/split_cuff/cuff.rfmodelname
sed -n '/>/p' $dir/split_cuff/cuff-CPC_left.fa |sed 's/>//g' |sort -u > $dir/split_cuff/cuff-CPC_left.name       ##the lncRNA name     
#cp $script/Library.pm $dir
diff $dir/split_cuff/cuff.rfmodelname $dir/split_cuff/cuff-CPC_left.name |grep "^<" |sed 's/< //g'> $dir/split_cuff/diff.txt  #########put the diff one into the cpc-left to further analysis
perl $script/extractFromFasta.pl $dir/split_cuff/cuff-protdb_blast_left.fa list $dir/split_cuff/diff.txt > $dir/split_cuff/cuff-rfmodeldiff.fa   ###get the diff sequence
sed 's/>//g' $dir/split_cuff/diff.txt |cat >> $dir/split_cuff/cuff-CPC_left.name
sort -u $dir/split_cuff/cuff-CPC_left.name > $dir/split_cuff/cuff-CPC_left.name1
mv $dir/split_cuff/cuff-CPC_left.name1 $dir/split_cuff/cuff-CPC_left.name
cat $dir/split_cuff/cuff-rfmodeldiff.fa >> $dir/split_cuff/cuff-CPC_left.fa 
