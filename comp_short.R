...
write.table(header, file = output, append = TRUE, quote = FALSE, sep = "\t", row.names = FALSE, col.names = FALSE)   ####write the header in the first line
...
#	return(mat2)
#	} else {
#	index3 <- tri_index(atriloc3)
#	index6 <- tri_index(atriloc6)
#	mat3 <- cbind(index3,index6)
#	return(mat3)
#	}
}
