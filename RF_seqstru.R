...
#feature <- cbind(comp,foldlen,lfold)
feature <- cbind(comp[order(rownames(comp)),,drop=F],fold[order(rownames(fold)),,drop=F],lfold[order(rownames(lfold)),,drop=F])
print(head(feature))

#######select top 50 performance features################
top <- c("orf_length","orf_standard_error","orf_coverage","orf_Mean","sequence_length","aag_eff","gaa_eff","agg_eff","gga_eff","agc_eff","cga_eff","cag_eff","gac_eff","ensemble_diversity","gct_eff","tcg_eff","distance_to_ensemble_energy","gag_eff","aga_eff","acg_eff","gca_eff","agt_eff","tga_eff","atg_eff","gta_eff","aac_eff","caa_eff","ggt_eff","tgg_eff","ctg_eff","gtc_eff","gat_eff","tag_eff","act_eff","tca_eff","cgg_eff","ggc_eff","cgt_eff","tgc_eff","atc_eff","cta_eff","gtt_eff","ttg_eff","ccg_eff","gcc_eff","ctt_eff","ttc_eff","gtg_eff","locally_stable_number","cat_eff","ctc_eff","tac_eff","aca_eff") 
com2 <- feature[,as.matrix(top)]
com2[is.na(com2)] <- 0
