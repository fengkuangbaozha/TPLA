...
filename <- args[6]
num1 <- as.numeric(args[7])
num2 <- as.numeric(args[8])
...
#plot2densityline(geneexonlen,lncexonlen,"exon length","Exon length distribution","lnc_exonlen.png",c("Long noncoding RNAs","Genes"))
...
#plot2densityline(genelen,lnclen,"Length","Transcript length distribution","lnc_length.png",c("Genes","Long noncoding RNAs"))
...
#contentplot(2,"GC content","The GC content of transcripts","lnc_gc.png")
#contentplot(3,"AU content","The AU content of transcripts","lnc_au.png")
#plot2densityline(data.matrix(seqcomp[genename,4]),data.matrix(seqcomp[lncname,4]),"GC/AU","GC/AU distribution","lnc_gc_au.png",c("Long noncoding RNAs","Genes"))
